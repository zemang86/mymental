...
export function StatsInfographic() {
  return (
    <div className="w-full">
      <div className="bg-gradient-to-r from-primary-50 via-white to-primary-50 dark:from-primary-950 dark:via-neutral-900 dark:to-primary-950 rounded-3xl p-8 md:p-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            ...
            >
              <CircleProgress percentage={50} size={180} delay={0}>
                <div className="text-center">
                  ...
                  <span className="text-3xl font-bold text-primary-800 dark:text-primary-200">50%</span>
                </div>
              </CircleProgress>
            ...
            >
              <CircleProgress percentage={50} size={160} strokeWidth={10} delay={0.3}>
                <div className="text-center">
                  <Globe className="w-5 h-5 mx-auto mb-1 text-primary-600 dark:text-primary-400" />
                  <span className="text-2xl font-bold text-primary-800 dark:text-primary-200">50%</span>
                </div>
              </CircleProgress>
          ...
          <div className="space-y-8">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-2xl md:text-3xl font-bold text-primary-800 dark:text-primary-200 mb-2">
                Did You Know?
              </h2>
            ...
            <motion.div
              ...
              className="p-4 rounded-xl bg-primary-100 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800"
            >
              <div className="flex items-center gap-2 mb-2">
                <TrendingUp className="w-5 h-5 text-primary-600 dark:text-primary-400" />
                <span className="font-semibold text-primary-800 dark:text-primary-200">Malaysia Statistics</span>
              </div>
              <p className="text-neutral-700 dark:text-neutral-300">
                In Malaysia, <span className="font-bold text-primary-600 dark:text-primary-400">29%</span> of adults are affected
